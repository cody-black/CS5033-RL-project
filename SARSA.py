...
# q_table = np.load("SARSA/{}/q_table.npy".format(ENV_NAME))
...
if not os.path.exists("SARSA/{}".format(ENV_NAME)):
    os.makedirs("SARSA/{}".format(ENV_NAME))

# Save data for processing later
np.save("SARSA/{}/q_table".format(ENV_NAME), q_table)
np.save("SARSA/{}/num_steps".format(ENV_NAME), steps)
np.save("SARSA/{}/rewards".format(ENV_NAME), ep_rewards)
np.save("SARSA/{}/successes".format(ENV_NAME), successes)
np.save("SARSA/{}/final_pos".format(ENV_NAME), final_pos)
